        ...
        <div class="flex  justify-center px-6 my-12">
            ...
            <x-splade-form :validateTrigger="'submit'" action="/login" method="POST">
                <a-card class="px-4 " body-style="width:500px">
                    ...
                    <GoogleLogin client_id="740173409691-mhrs1kqmnl6btjp6991rkeptl2dor47s.apps.googleusercontent.com">
                        <button
                            class="flex m-auto mt-5 items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
