          ...
          <div class="w-full h-100">
            ...
            <a-form @submit="submit" :model="form" class="mt-6" action="#" method="POST">
              <a-input-item name="username" :rules="[{ required: true, message: 'Please input your username!' }]" label="">
                ...
                <input v-model="form.username"  name=""  placeholder="Username" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autofocus autocomplete required>
              </a-input-item>
