...
const configNames = [
  'square_app_id',
  'square_access_token',
  'square_payment_enable',
  'square_location_id',
  'square_environment',

  'paypal_payment_enable',
  'paypal_client_id',
...
<template>
  <a-form autocomplete="off" v-bind="formConfig" @finish="submit">
    ...
    <div v-if="formState.select_payment == 'square'">
      ...
      <a-form-item name="square_app_id" label="Enable Square Payment" :rules="[{ required: true }]">
        <a-switch :showCount="true" maxlength="55" autocomplete="off"
                  checkedValue="active"
                  v-model:checked="formState.square_payment_enable">
        </a-switch>
      </a-form-item>
    ...
    <div v-if="formState.select_payment == 'paypal'">
      <a-form-item label="Enable Paypal Payment">
        <a-switch :showCount="true" maxlength="55" autocomplete="off"
                  checkedValue="active"
                  v-model:checked="formState.paypal_payment_enable">
        </a-switch>
      </a-form-item>
    ...
    <div v-if="formState.select_payment == 'authorize'">
      ...
      <a-form-item name="authorize_transaction_key" label="Authorize.net Transaction Key">
        <a-input autocomplete="off" v-model:value="formState.authorize_transaction_key"
