    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                dark:hover:bg-gray-700 group @if($routeName == 'profile.cart' || $routeName == 'profile.checkout')text-indigo-600 @endif">
                    <svg class="h-5 w-5 text-gray-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li>
                <a href="{{route('profile.order')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100
                 dark:hover:bg-gray-700 group @if($routeName == 'profile.order' || $routeName == 'profile.order-detail')text-indigo-600 @endif">
                    <svg class="h-5 w-5 text-gray-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
