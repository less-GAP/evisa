...
@section('content')
    <div class="w-4/6 m-auto bg-white mt-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-gray-200">
                        <div class="bg-white shadow-md rounded-lg ">
                            <a href="#">
                                <img class="rounded-t-lg p-8" src="http://localhost:9100/upload//file/Upload/64d2082be9180_bacsic.png" alt="product image">
                            </a>
                            <div class="px-5 pb-5">
                                <a href="#">
    ...
    {{--        @include("Frontend::profile.sidebar")--}}
    {{--        <div class="container xl:col-span-6">--}}
    {{--            <div class="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700 col-span-3">--}}
    {{--                <a href="#">--}}
    {{--                    <img class="rounded-t-lg p-8" src="http://localhost:9100/upload//file/Upload/64d2082be9180_bacsic.png" alt="product image">--}}
    {{--                </a>--}}
    {{--                <div class="px-5 pb-5">--}}
